...
export default function Hero() {
  return (
    ...
    >
      {/* Background Glow */}
      <div
        className="pointer-events-none absolute left-1/2 top-[24%] h-105 w-190
        -translate-x-1/2 -translate-y-1/2 rounded-full
        bg-cyprus/5 blur-[140px]"
      />
      ...
      <Container>
        ...
        <motion.div
          ...
          className="relative z-10 mx-auto mb-8 max-w-5xl px-1 text-center
          sm:mb-12 sm:px-0"
        >
          {/* Small Trust Badge */}
          <motion.div
          ...
          {/* Main Heading */}
          <h1
            className="font-serif text-[2.35rem] font-bold leading-[1.08]
          ...
          {/* Description */}
          <p
            className="mx-auto mt-4 max-w-85
            text-sm font-medium leading-6 text-muted
            sm:mt-6 sm:max-w-2xl sm:text-base sm:leading-7
          ...
          <motion.p
            ...
            text-[11px] font-medium leading-5 text-muted/80
            sm:max-w-none sm:text-xs"
          >
        ...
        <motion.div
          ...
          className="relative mx-auto -mb-2 flex w-full
          max-w-6xl justify-center px-0
          sm:px-4"
        >
          <div
